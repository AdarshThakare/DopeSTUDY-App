...
import com.sample.dopestudyapp.enums.Constants.ACTION_SERVICE_CANCEL
import com.sample.dopestudyapp.enums.Constants.ACTION_SERVICE_START
import com.sample.dopestudyapp.enums.Constants.ACTION_SERVICE_STOP
...
import hilt_aggregated_deps._com_sample_dopestudyapp_session_StudySessionTimerService_GeneratedInjector
...
private fun SessionScreen(
    ...
    timerService: StudySessionTimerService = StudySessionTimerService()
    ...
    Scaffold(
        ...
        LazyColumn (
            ...
            item{
                    Button(modifier = Modifier.fillMaxWidth().padding(horizontal = 12.dp, vertical = 10.dp),onClick = {
                        val noteIntent = Intent(Intent.ACTION_CREATE_NOTE)

                        val shareIntent = Intent.createChooser(noteIntent, "Take Notes using:")
                    ...
                    Text(text = "Take Notes for the Session")
